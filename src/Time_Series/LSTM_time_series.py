...
data = df['money'].values.reshape(-1, 1) #extract the money column, represent sales 
...
#Preparing Sequences for Time Series
sequence_length = 10

#Custom Dataset Class (Custom PyTorch Dataset)
...
#LSTM Model
#2 LSTM layers, 64 hidden units, and 0.3 dropout.
...
plt.title("Plain LSTM Coffee Sales Forecasting")
plt.legend()
plt.grid(True)
plt.show()